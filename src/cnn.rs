...
pub const INPUT_DIM: usize = 100;                                                // 100x100 image
pub const FILTER_DIM: usize = 5;                                                 // 5x5 convolution matrix
pub const CONV_OUT_DIM: usize = INPUT_DIM / FILTER_DIM;                          // 20x20 convolution layer matrix
pub const CONV_LAYER_SIZE: usize = 10;                                           // 10 convolution layer neurons
pub const OUT_NEURON_DIM: usize = CONV_OUT_DIM * CONV_OUT_DIM * CONV_LAYER_SIZE; // 4000x1 weight vector
pub const OUT_LAYER_SIZE: usize = 10;                                            // 10 output layer neurons

// Use repr(transparent) so the types have same memory layout as arrays
// Describes datastructures for the CNN
#[repr(transparent)]
